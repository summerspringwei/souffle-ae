...
APOLLO_BERT_LATENCY=$(python3 extract_nsys_cuda_kernel_latency.py apollo-bert-nsys.csv)
...
APOLLO_RESNEXT_LATENCY=$(python3 extract_nsys_cuda_kernel_latency.py apollo-resnext_imagenet_101-nsys.csv)
...
APOLLO_EFFICIENTNET_LATENCY=$(python3 extract_nsys_cuda_kernel_latency.py apollo-efficientnet-b0-nsys.csv)
...
APOLLO_SWIN_TRANS_LATENCY=$(python3 extract_nsys_cuda_kernel_latency.py apollo-swin-transformer-nsys.csv)
...
APOLLO_MMoE_LATENCY=$(python3 extract_nsys_cuda_kernel_latency.py apollo-tf_MMoE_1_100_16_8_2-nsys.csv)

echo "Apollo: " ${APOLLO_BERT_LATENCY}, ${APOLLO_RESNEXT_LATENCY}, ${APOLLO_LSTM_LATENCY}, ${APOLLO_EFFICIENTNET_LATENCY}, ${APOLLO_SWIN_TRANS_LATENCY}, ${APOLLO_MMoE_LATENCY}
