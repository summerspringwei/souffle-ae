...
nsys profile --stats=true -o iree-resnext_imagenet_101-nsys -f true \
  python3 /workspace/mindspore_models/official/cv/resnext/my_run_resnext101.py > resnext_tmp.txt
...
nsys profile --stats=true -o iree-efficientnet-b0-nsys -f true \
  ...
  --config_path /workspace/mindspore_models/official/cv/efficientnet/efficientnet_b0_imagenet_config.yaml > efficient_net_tmp.txt
...
nsys profile --stats=true -o iree-swin-transformer-nsys -f true \
  ...
  --swin_config /workspace/mindspore_models/research/cv/swin_transformer/src/configs/swin_base_patch4_window7_224.yaml > swin_transformer_tmp.txt
