...
# BERT
cd /workspace/mindspore/model_zoo/official/nlp/bert/src
nsys profile --stats=true -o apollo-bert-nsys -f true \
  python3 my_run_bert.py > bert_tmp.txt
...
# ResNext
cd /workspace/model_zoo_mindspore/models/official/cv/resnext
nsys profile --stats=true -o iree-resnext_imagenet_101-nsys -f true \
  python3 my_run_resnext101.py > resnext_tmp.txt
...
# EfficientNet
cd /workspace/model_zoo_mindspore/models/official/cv/efficientnet
nsys profile --stats=true -o iree-efficientnet-b0-nsys -f true \
  python3 my_run_efficientnet.py --config_path efficientnet_b0_imagenet_config.yaml > efficient_net_tmp.txt
...
# SwinTrans.
cd /workspace/model_zoo_mindspore/models/research/cv/swin_transformer
nsys profile --stats=true -o iree-swin-transformer-nsys -f true \
  python3 my_run_swin_transformer.py --swin_config src/configs/swin_base_patch4_window7_224.yaml > swin_transformer_tmp.txt
...
nsys profile --stats=true -o iree-tf_MMoE_1_100_16_8_2-nsys -f true \
  python3 mindspore_mmoe.py > mmoe_tmp.txt
