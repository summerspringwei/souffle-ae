...
IREE_BERT_LATENCY=$(python3 extract_nsys_cuda_kernel_latency.py iree-bert-nsys.csv)
bert_layer=12
...
IREE_RESNEXT_LATENCY=$(python3 extract_nsys_cuda_kernel_latency.py iree-resnext_imagenet_101-nsys.csv)
...
IREE_LSTM_LATENCY=$(python3 extract_nsys_cuda_kernel_latency.py iree-tf_lstm-nsys.csv)
...
IREE_EFFICIENTNET_LATENCY=$(python3 extract_nsys_cuda_kernel_latency.py iree-efficientnet-b0-nsys.csv)
...
IREE_SWIN_TRANS_LATENCY=$(python3 extract_nsys_cuda_kernel_latency.py iree-swin-transformer-nsys.csv)
