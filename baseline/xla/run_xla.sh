...
ncu -i swin-trans-ncu.ncu-rep --csv --page raw > swin-trans-ncu-raw.xla.csv
...
echo "XLA: ," ${XLA_BERT_LATENCY}, ${XLA_RESNEXT_LATENCY}, ${XLA_LSTM_LATENCY}, ${XLA_EFFICIENT_LATENCY}, ${XLA_SWIN_TRANS_LATENCY}, ${XLA_MMoE_LATENCY}
